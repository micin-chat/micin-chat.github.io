let APP_ID = 'f6ed18dff8f24668895db128ec5ec6c0'
...
let toggleCamera = async () => {
    ...
    if (videoTrack.enabled) {
        ...
        document.getElementById('camera-btn').style.backgroundColor = 'rgb(176, 102, 249, .9)'
    }
}
...
let toggleMic = async () => {
    ...
    if (audioTrack.enabled) {
        ...
        document.getElementById('mic-btn').style.backgroundColor = 'rgb(176, 102, 249, .9)'
    }
}
